...
const Subscribe = () => {
    ...
    const sendMail = e => {
        e.preventDefault();
        send('service_3ms3oz6', 'template_znzsasq', { subscriber_email }, 'bzbzNMd6ZGIZbaSXk')
            .then(response => {
        ...
        <div class="subscribe">
            ...
            <form onSubmit={sendMail}>
                <div class="subscriptionfield">
                    <input type="text" placeholder="Enter your email" value={subscriber_email} onChange={handleName} />
